...
def siapa():
	...
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mSelamat datang \033[1;92m" +nama+ "\n\033[1;97mTerimakasih telah menggunakan tools ini !! Jangan Lupa\nSUBSCRIBE channel \033[1;92mDNAD OFFICIAL")
		time.sleep(1)
		loginSC()
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/c/dnadofficial')
				menu()
