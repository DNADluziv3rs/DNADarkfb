...
def siapa():
	...
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mSelamat datang \033[1;92m" +nama+ "\n\033[1;97mTerimakasih telah menggunakan tools ini !! Jangan Lupa SUBSCRIBE channel DNAD OFFICIAL")
		time.sleep(1)
		loginSC()
